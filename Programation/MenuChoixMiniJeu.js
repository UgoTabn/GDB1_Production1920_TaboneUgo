...
create(){
	...
	this.button.on('pointerdown', function(){this.scene.start("MiniJeuUnUniquement");}, this) //bouton pour lancer le jeu un
	
	this.button = this.add.sprite(100, 10, 'jeuDeux').setInteractive();
	this.button.on('pointerdown', function(){this.scene.start("MiniJeuDeuxUniquement");}, this) //bouton pour lancer le jeu deux
	
	this.button = this.add.sprite(150, 10, 'jeuTrois').setInteractive();
	this.button.on('pointerdown', function(){this.scene.start("MiniJeuTroisUniquement");}, this) //bouton pour lancer le jeu trois
}
