class MiniJeuDeuxUniquement extends Phaser.Scene {
  constructor(){
    super("MiniJeuDeuxUniquement")
  }
...
create(){
	...
	miniJeu_Reussi = 0;
	majHP();
	this.time.addEvent({ delay: 1250, callback:enchainementDeSceneDeux, callbackScope: this, loop: false });	
